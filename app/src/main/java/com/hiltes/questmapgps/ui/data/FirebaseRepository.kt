package com.hiltes.questmapgps.data

import com.hiltes.questmapgps.ui.data.UserData
...
class FirebaseRepository {
    ...
    suspend fun getUsersPage(pageSize: Int, lastPoints: Int? = null): List<UserData> {
